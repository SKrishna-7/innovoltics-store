...
const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      setSelectedModel(foundProduct.model[0]);
      setModelPath(foundProduct.model[0].mod);
    } else {
                  ...
                  {product.materials.map((material) => (
                    <button
                      ...
                      className={`relative px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${
                        ...
                        selectedMaterial?.name === material.name && material.inStock
                  ...
                  {product.model.map((m) => (
                    <button
                      ...
                      className={`relative px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${
                        ...
                        selectedModel?.name === m.name && m.inStock
                          ? "border-blue-600 bg-blue-50"
                          : ""
                      }`}
                    >
            ...
            {relatedProducts.map((relatedProduct) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <Link
                    href={`/products/${relatedProduct.id}`}
                    className="mt-3 inline-block px-4 py-1.5 bg-blue-600 text-white text-sm font-medium rounded-full hover:bg-blue-700 transition-colors duration-300"
                  >
                    View Product
                  </Link>
                </div>
