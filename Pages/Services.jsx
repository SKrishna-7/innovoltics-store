...
export default function Services() {
  return (
    <div className="w-full min-h-screen bg-gray-900 text-gray-100 font-poppins text-balance">
      <div className="max-w-7xl mx-auto lg:px-6 py-12 lg:py-16">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          {/* Left Section: Intro and Image */}
          <div className="w-full lg:w-[40%] p-6 lg:p-10">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-100 mb-6">
              What We Offer?
            </h1>
            <p className="max-w-full text-sm sm:text-sm text-gray-300 mb-6">
          ...
          <div className="w-full lg:w-[50%] px-5  lg:py-0">
            ...
            <div className="border-b-2 border-purple-500 mb-6  pb-6">
              ...
              <p className="text-sm sm:text-sm text-gray-300 mb-4">
